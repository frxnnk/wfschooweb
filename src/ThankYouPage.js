...
export default () => {
  ...
  const downloadUrl = "/TeachingBear-ui.zip"
  React.useEffect(() => {
        ...
        <Content2Xl>
          ...
          <HeroRow>
            ...
            <div tw="mt-12 text-center">
              I am working on another library similar to TeachingBear, with <span tw="font-bold">more components</span> and a much <span tw="font-bold">better developer
              experience</span>.
            </div>
            <div tw="mt-12 text-center">
              If you liked TeachingBear and would like to get updates on the library I am working on among other things, do <span tw="font-bold">follow</span> me on
              Twitter/GitHub.
